...
const DICT = {
  uk: {
    ...
    'ai.hint': "Застосунок показуватиме слова, а ви відповідатимете «Знаю» / «Не знаю». Він запам'ятає результат, сам визначить ваш рівень і надалі підбиратиме слова під нього: складні — частіше, засвоєні — прибиратиме. Інколи він попросить написати слово по буквах або продиктувати його вголос.",
    'ai.source': 'Звідки брати слова',
    'ai.sourceBank': '📖 Вбудований словник (офлайн)',
    'ai.sourceAi': '🤖 AI за темою (потрібен ключ)',
    'ai.sourceHint': 'Словник — 5000 найуживаніших слів із прикладами, працює без інтернету й без ключа. AI підбирає слова під будь-яку тему.',
    'ai.bankEmpty': 'Словник вичерпано — усі слова вже показані.',
    ...
    'settings.credits': 'Словник зібрано з відкритих джерел: Вікісловник (CC BY-SA 4.0), приклади речень — Tatoeba (CC BY 2.0 FR), частотність — OpenSubtitles.',
  ...
  en: {
    ...
    'ai.hint': 'The app shows you words and you answer “I know” / “I don’t know”. It remembers the result, works out your level and picks words to match: hard ones more often, mastered ones dropped. Sometimes it will ask you to spell a word or say it out loud.',
    'ai.source': 'Where to take words from',
    'ai.sourceBank': '📖 Built-in dictionary (offline)',
    'ai.sourceAi': '🤖 AI by topic (needs a key)',
    'ai.sourceHint': 'The dictionary holds the 5000 most common words with examples and works with no internet and no key. AI picks words for any topic you name.',
    'ai.bankEmpty': 'Dictionary exhausted — every word has been shown.',
    ...
    'settings.credits': 'The dictionary is built from open sources: Wiktionary (CC BY-SA 4.0), example sentences from Tatoeba (CC BY 2.0 FR), frequency data from OpenSubtitles.',
  ...
  nl: {
    ...
    'ai.hint': 'De app laat woorden zien en jij antwoordt “Ik weet het” / “Ik weet het niet”. Hij onthoudt het resultaat, bepaalt je niveau en kiest daar woorden bij: moeilijke vaker, beheerste verdwijnen. Soms vraagt hij je een woord te spellen of hardop uit te spreken.',
    'ai.source': 'Waar de woorden vandaan komen',
    'ai.sourceBank': '📖 Ingebouwd woordenboek (offline)',
    'ai.sourceAi': '🤖 AI op onderwerp (sleutel nodig)',
    'ai.sourceHint': 'Het woordenboek bevat de 5000 meestgebruikte woorden met voorbeelden en werkt zonder internet en zonder sleutel. AI kiest woorden bij elk onderwerp dat je opgeeft.',
    'ai.bankEmpty': 'Woordenboek op — alle woorden zijn al getoond.',
    ...
    'settings.credits': 'Het woordenboek is samengesteld uit open bronnen: Wiktionary (CC BY-SA 4.0), voorbeeldzinnen van Tatoeba (CC BY 2.0 FR), frequentiegegevens van OpenSubtitles.',
